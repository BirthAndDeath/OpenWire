...
pub use identity::{Identity, init, init_path, pool, add_identity, get_current_identity, set_current_identity, list_identities, delete_identity, set_private_key, get_private_key};
